...
if ( ! function_exists( 'playerx_edge_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function playerx_edge_fonts_options_map() {
		
		playerx_edge_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'playerx' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = playerx_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'playerx' )
			)
		);
		
		//H1
		$group_heading_h1 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = playerx_edge_add_admin_row(
			array(
		...
		playerx_edge_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'playerx' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h1_3 = playerx_edge_add_admin_row(
			array(
		...
		playerx_edge_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'playerx' ),
		...
		playerx_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'playerx' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h2_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h2_3 = playerx_edge_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h3_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h3_3 = playerx_edge_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h4_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h4_3 = playerx_edge_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h5_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h5_3 = playerx_edge_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'playerx' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h6_2 = playerx_edge_add_admin_row(
			array(
		...
		$row_heading_h6_3 = playerx_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = playerx_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'playerx' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = playerx_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = playerx_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = playerx_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = playerx_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = playerx_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'playerx' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = playerx_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = playerx_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'playerx' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = playerx_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = playerx_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = playerx_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = playerx_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = playerx_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = playerx_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = playerx_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'playerx' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = playerx_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = playerx_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = playerx_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = playerx_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = playerx_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = playerx_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = playerx_edge_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = playerx_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'playerx' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'playerx' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'playerx' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'playerx' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'playerx' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'playerx' ),
				'description' => esc_html__( 'Define styles for link text', 'playerx' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		playerx_edge_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'playerx' ),
				'parent'        => $row_link_1
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'playerx' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = playerx_edge_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		playerx_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'playerx' ),
				'options'       => playerx_edge_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'playerx' ),
				'options'       => playerx_edge_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'playerx_edge_action_options_map', 'playerx_edge_fonts_options_map', 3 );
}
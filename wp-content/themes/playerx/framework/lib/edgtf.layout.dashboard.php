...
/*
   Class: PlayerxEdgeClassDashboardForm
   A class that initializes Edge Dashboard Container
*/

class PlayerxEdgeClassDashboardForm implements iPlayerxEdgeInterfaceLayoutNode, iPlayerxEdgeInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: PlayerxEdgeClassDashboardGroup
   A class that initializes PlayerxEdgeClass Group Field
*/

class PlayerxEdgeClassDashboardGroup implements iPlayerxEdgeInterfaceLayoutNode, iPlayerxEdgeInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: PlayerxEdgeClassDashboardTitle
   A class that initializes Dashboard Title
*/

class PlayerxEdgeClassDashboardTitle implements iPlayerxEdgeInterfaceRender {
	private $name;
	private $title;
...
/*
   Class: PlayerxEdgeClassDashboardField
   A class that initializes PlayerxEdgeClass Front Field
*/

class PlayerxEdgeClassDashboardField implements iPlayerxEdgeInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class PlayerxEdgeClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class PlayerxEdgeClassDashboardFieldText extends PlayerxEdgeClassDashboardFieldType {
...
class PlayerxEdgeClassDashboardFieldTextArea extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class PlayerxEdgeClassDashboardFieldImage extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
            ...
            <div class="edgtf-dashboard-gallery-holder">
                <ul class="edgtf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo playerx_edge_get_module_part( $value_html );
					} ?>
                </ul>
                <div class="edgtf-dashboard-gallery-uploader">
					<?php
					if ( playerx_membership_theme_installed() ) {
						echo playerx_edge_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'playerx' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'playerx' ) . '</span></a>';
					} ?>
                    <input class="edgtf-dashboard-gallery-upload-hidden" type="file" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_html( $name ); ?>"
                            value="">
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
                        <button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'playerx' ); ?></button>
					<?php } ?>
                </div>
            </div>
        </div>
...
class PlayerxEdgeClassDashboardFieldGallery extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class PlayerxEdgeClassDashboardFieldSelect extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class PlayerxEdgeClassDashboardFieldDate extends PlayerxEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class PlayerxEdgeClassDashboardFieldIcon extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = playerx_edge_icon_collections()->getIconCollectionsEmpty();
...
class PlayerxEdgeClassDashboardFieldColor extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class PlayerxEdgeClassDashboardFieldCheckBoxGroup extends PlayerxEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class PlayerxEdgeClassDashboardFieldAddress extends PlayerxEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class PlayerxEdgeClassDashboardRepeater implements iPlayerxEdgeInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
                <div class="edgtf-dashboard-repeater-table-heading">
                    <div class="edgtf-dashboard-repeater-fields-holder">
                        <div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'playerx' ) ?></div>
                        ...
                        <div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'playerx' ) ?></div>
                    </div>
                </div>
			<?php } ?>
...
class PlayerxEdgeClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new PlayerxEdgeClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new PlayerxEdgeClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new PlayerxEdgeClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'image':
				$field = new PlayerxEdgeClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new PlayerxEdgeClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'select':
				$field = new PlayerxEdgeClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'icon':
				$field = new PlayerxEdgeClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'color':
				$field = new PlayerxEdgeClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new PlayerxEdgeClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new PlayerxEdgeClassDashboardFieldAddress();

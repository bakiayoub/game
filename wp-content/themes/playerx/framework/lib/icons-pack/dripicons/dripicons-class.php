...
if ( ! function_exists( 'playerx_edge_add_dripicons_icon_pack' ) ) {
	function playerx_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new PlayerxEdgeClassDripicons( 'Dripicons', 'dripicon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_dripicons_icon_pack_option' ) ) {
	function playerx_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_dripicons_icon_pack_option' );
}

class PlayerxEdgeClassDripicons implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

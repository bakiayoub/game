...
if ( ! function_exists( 'playerx_edge_add_font_elegant_icon_pack' ) ) {
	function playerx_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new PlayerxEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_font_elegant_icon_pack_option' ) ) {
	function playerx_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'playerx_edge_filter_add_icon_pack_into_social_options', 'playerx_edge_add_font_elegant_icon_pack_option' );
}

class PlayerxEdgeClassIconsFontElegant implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

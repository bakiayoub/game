...
if ( ! function_exists( 'playerx_edge_add_font_awesome_icon_pack' ) ) {
	function playerx_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new PlayerxEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_font_awesome_icon_pack_option' ) ) {
	function playerx_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'playerx_edge_filter_add_icon_pack_into_social_options', 'playerx_edge_add_font_awesome_icon_pack_option' );
}

class PlayerxEdgeClassIconsFontAwesome implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

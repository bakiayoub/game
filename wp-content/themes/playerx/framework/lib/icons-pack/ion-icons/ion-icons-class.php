...
if ( ! function_exists( 'playerx_edge_add_ion_icon_pack' ) ) {
	function playerx_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new PlayerxEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_ion_icon_pack_option' ) ) {
	function playerx_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_ion_icon_pack_option' );
	add_filter( 'playerx_edge_filter_add_icon_pack_into_social_options', 'playerx_edge_add_ion_icon_pack_option' );
}

class PlayerxEdgeClassIonIcons implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;

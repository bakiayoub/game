...
if ( ! function_exists( 'playerx_edge_add_linea_icon_pack' ) ) {
	function playerx_edge_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new PlayerxEdgeClassLineaIcons( 'Linea Icons', 'linea_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_linea_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_linea_icon_pack_option' ) ) {
	function playerx_edge_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_linea_icon_pack_option' );
}

class PlayerxEdgeClassLineaIcons implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

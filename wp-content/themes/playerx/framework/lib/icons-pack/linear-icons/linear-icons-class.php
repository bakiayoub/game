...
if ( ! function_exists( 'playerx_edge_add_linear_icon_pack' ) ) {
	function playerx_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new PlayerxEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_linear_icon_pack_option' ) ) {
	function playerx_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_linear_icon_pack_option' );
}

class PlayerxEdgeClassLinearIcons implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

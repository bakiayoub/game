...
if ( ! function_exists( 'playerx_edge_add_simple_line_icon_pack' ) ) {
	function playerx_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new PlayerxEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );

		return $iconCollections;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_collection', 'playerx_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'playerx_edge_add_simple_line_icon_pack_option' ) ) {
	function playerx_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'playerx' );

		return $options;
	}

	add_filter( 'playerx_edge_filter_add_icon_pack_into_options', 'playerx_edge_add_simple_line_icon_pack_option' );
	add_filter( 'playerx_edge_filter_add_icon_pack_into_social_options', 'playerx_edge_add_simple_line_icon_pack_option' );
}

class PlayerxEdgeClassSimpleLineIcons implements iPlayerxEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function setSocialIconsArray() {
		$this->socialIcons = array(
			''                        => '',
			'icon-social-behance'     => esc_html__( 'Behance', 'playerx' ),
			'icon-social-dribbble'    => esc_html__( 'Dribbble', 'playerx' ),
			'icon-social-dropbox'     => esc_html__( 'Dropbox', 'playerx' ),
			'icon-social-facebook'    => esc_html__( 'Facebook', 'playerx' ),
			'icon-social-foursquare'  => esc_html__( 'Foursquare', 'playerx' ),
			'icon-social-github'      => esc_html__( 'Github', 'playerx' ),
			'icon-social-gplus'       => esc_html__( 'Google Plus', 'playerx' ),
			'icon-social-instagram'   => esc_html__( 'Instagram', 'playerx' ),
			'icon-social-linkedin'    => esc_html__( 'LinkedIn', 'playerx' ),
			'icon-social-pintarest'   => esc_html__( 'Pinterest', 'playerx' ),
			'icon-social-reddit'      => esc_html__( 'Reddit', 'playerx' ),
			'icon-social-skype'       => esc_html__( 'Skype', 'playerx' ),
			'icon-social-soundcloud'  => esc_html__( 'Soundcloud', 'playerx' ),
			'icon-social-stumbleupon' => esc_html__( 'Stumbleupon', 'playerx' ),
			'icon-social-spotify'     => esc_html__( 'Spotify', 'playerx' ),
			'icon-social-tumblr'      => esc_html__( 'Tumblr', 'playerx' ),
			'icon-social-twitter'     => esc_html__( 'Twitter', 'playerx' ),
			'icon-social-youtube'     => esc_html__( 'Youtube', 'playerx' )
		);
	}

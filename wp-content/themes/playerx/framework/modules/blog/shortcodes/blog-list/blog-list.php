<?php
namespace PlayerxCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'playerx' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'playerx' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'playerx' ),
						'value'      => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'playerx' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'playerx' ),
						'value'      => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'playerx' ),
						'value'      => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'playerx' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'playerx' ),
						'value'      => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'playerx' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'playerx' ),
						'value'      => array_flip( playerx_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'playerx' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'playerx' ),
						'value'      => array(
							esc_html__( 'None', 'playerx' )            => 'no-pagination',
							esc_html__( 'Standard', 'playerx' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'playerx' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'playerx' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'playerx' )
					)
				)
			)
		);

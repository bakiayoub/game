...
if ( ! function_exists( 'playerx_edge_error_404_options_map' ) ) {
	function playerx_edge_error_404_options_map() {
		
		playerx_edge_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'playerx' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = playerx_edge_add_admin_panel(
			array(
		...
		playerx_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'playerx' )
			)
		);
		...
		$panel_404_options = playerx_edge_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'playerx' )
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'playerx' )
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Pattern Background Image', 'playerx' ),
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'playerx' )
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'playerx' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'playerx' )
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'playerx' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'playerx' )
			)
		);
		...
		$first_level_group = playerx_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'playerx' )
			)
		);
        ...
        $first_level_group_responsive = playerx_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'playerx' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'playerx' )
            )
        );
		...
		playerx_edge_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'playerx' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'playerx' )
			)
		);
		...
		$second_level_group = playerx_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'playerx' )
			)
		);
        ...
        $second_level_group_responsive = playerx_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'playerx' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'playerx' )
            )
        );
		...
		playerx_edge_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'playerx' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'playerx' )
			)
		);
		...
		$third_level_group = playerx_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'playerx' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'playerx' )
			)
		);
        ...
        $third_level_group_responsive = playerx_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'playerx' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'playerx' )
            )
        );
		...
		playerx_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'playerx' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'playerx' )
			)
		);
		...
		playerx_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'playerx' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'playerx' ),
					'light-style' => esc_html__( 'Light', 'playerx' )
				)
			)
		);
	}
	
	add_action( 'playerx_edge_action_options_map', 'playerx_edge_error_404_options_map', 19 );
}
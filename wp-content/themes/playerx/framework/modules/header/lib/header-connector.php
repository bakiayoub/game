...
namespace PlayerxEdgeNamespace\Modules\Header\Lib;
/**
 * Class PlayerxEdgeClassHeaderConnector
 *
...
class PlayerxEdgeClassHeaderConnector {
	...
	public function connect( $config = array() ) {
		do_action( 'playerx_edge_action_pre_header_connect' );
		...
		if ( ! empty( $config['affect_content'] ) ) {
			add_filter( 'playerx_edge_filter_content_elem_style_attr', array( $this, 'contentMarginFilter' ) );
		}
		
		if ( ! empty( $config['affect_title'] ) ) {
			add_filter( 'playerx_edge_filter_title_content_padding', array( $this, 'titlePaddingFilter' ) );
		}
		
		do_action( 'playerx_edge_action_after_header_connect' );
	}
	 ...
	 *
	 * Hooks to playerx_edge_filter_title_content_padding filter
	 *
	 * @return int
	 */

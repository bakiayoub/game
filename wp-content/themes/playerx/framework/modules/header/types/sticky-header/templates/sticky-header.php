...
<div class="edgtf-sticky-header">
                ...
                <div class="edgtf-position-left"><!--
                 --><div class="edgtf-position-left-inner">
                        ...
                        <?php if($menu_area_position === 'left') : ?>
                            <?php playerx_edge_get_sticky_menu('edgtf-sticky-nav'); ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="edgtf-position-right"><!--
                 --><div class="edgtf-position-right-inner">
                        <?php if($menu_area_position === 'right') : ?>
                            <?php playerx_edge_get_sticky_menu('edgtf-sticky-nav'); ?>
                        <?php endif; ?>
                        <?php playerx_edge_get_sticky_header_widget_menu_area(); ?>
                    </div>
                </div>
            </div>
            <?php if($sticky_header_in_grid) : ?>
	...
	<?php do_action( 'playerx_edge_action_before_sticky_menu_html_close' ); ?>
</div>

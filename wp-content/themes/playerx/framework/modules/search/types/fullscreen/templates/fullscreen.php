<div class="edgtf-fullscreen-search-holder">
	<a <?php playerx_edge_class_attribute( $search_close_icon_class ); ?> href="javascript:void(0)">
					...
					<div class="edgtf-form-holder">
						<div class="edgtf-form-holder-inner">
							<div class="edgtf-field-holder">
								<input type="text" placeholder="<?php esc_attr_e( 'TYPE YOUR SEARCH...', 'playerx' ); ?>" name="s" class="edgtf-search-field" autocomplete="off"/>
							</div>

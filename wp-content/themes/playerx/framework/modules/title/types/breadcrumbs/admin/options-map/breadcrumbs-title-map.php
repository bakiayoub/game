...
if ( ! function_exists('playerx_edge_breadcrumbs_title_type_options_map') ) {
	function playerx_edge_breadcrumbs_title_type_options_map($panel_typography) {
		
		playerx_edge_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'playerx' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = playerx_edge_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'playerx' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'playerx' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = playerx_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = playerx_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = playerx_edge_add_admin_row(
				array(
	...
	add_action( 'playerx_edge_action_additional_title_typography_options_map', 'playerx_edge_breadcrumbs_title_type_options_map');
}